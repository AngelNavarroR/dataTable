...
import ui.component.utils.refleccion.UtilConstants;
...
//    public static final String UTF_8 = Charsets.UTF_8.name();
     ...
     * @param length Specifies how many characters to return. If set to 0, an
     * empty string ("") is returned. If set to greater than or equal to the
     * length of the string, the entire string is returned.
     * @return The part of the given <code>String</code> or null if the
     * parameter text is null.
     * @see #len(String) to determine the number of characters in a
     * <code>String</code>.
     ...
     * @return The part of the given <code>String</code> or null if the
     * parameter text is null.
     * @see #len(String) function to determine the number of characters in a
     * <code>String</code>.
     * @see #left(String, int)
     */
     ...
     * @param start Specifies the starting position for the operation. If set to
     * greater than the number of characters in the <code>String</code>, an
     * empty string ("") will be returned.
     * @param length The number of characters to return.
     * @return The part of the given <code>String</code> or null if the
     * parameter text is null.
     * @see len function to determine the number of characters in a
     * <code>String</code>.
     */
    ...
    /**
     * Returns the number of characters in a <code>String</code>. The following
     * example will calculate the value 11:
     * <pre>
     * String text = "Just a Text"
     * int length = len (text);
     * </pre>
     *
     * @param text The <code>String</code> from which character count are
     * returned.
     * @return The number of characters in the <code>String</code> specified in
     * the parameter text. Returns -1 if the parameter text is null.
     */
    ...
    /**
     * Converts a specified <code>String</code> to lower case. The following
     * example creates the <code>String</code> "just a text" from "Just a Text".
     * <pre>
     * String text = "Just a Text"
     * String lcaseText = lCase (text);
     * </pre>
     *
     * @param text The <code>String</code> which should be converted to
     * lowercase.
     * @return a <code>String</code> that has been converted into lower case
     * characters or <code>null</code> if the parameter text is
     * <code>null</code>.
     */
    ...
    /**
     * Converts a specified <code>String</code> to upper case. The following
     * example creates the <code>String</code> "JUST A TEXT" from "Just a Text".
     * <pre>
     * String text = "Just a Text"
     * String uCaseText = uCase (text);
     * </pre> Instead of the java {@link String#toUpperCase()} method, this one
     * did not convert an ß into a 'SS'. The ß keeps untouched.
     *
     * @param text The <code>String</code> which should be converted to upper
     * case.
     * @return a <code>String</code> that has been converted into upper case
     * characters or <code>null</code> if the parameter text is
     * <code>null</code>.
     */
    ...
    /**
     * Searches for all occurrences specified with the <code>search</code>
     * parameter in the <code>text</code>.
     *
     * @param text The text to be searched in.
     * @param search The <code>String</code> value to be searched for in the
     * <code>text</code>
     * @param compare Specifies the string comparison to use.
     * <ul>
     * <li>0 = COMPARE_BINARY - Perform a binary comparison (case
     * sensitive)</li>
     * <li>1 = COMPARE_TEXT - Perform a textual comparison (case
     * insensitive)</li>
     * </ul>
     * @return The number of occurrences found within the <code>text</code>
     * parameter.
     */
     ...
     * insensitive)</li>
     * </ul>
     * @param openExclusion An array with Strings containing the marker that
     * defines the beginning of an area in the given text which will not be
     * processed.
     * @param closeExclusion An array with Strings containing the marker that
     * defines the end of an area in the given text which will not be processed.
     * @return The number of occurrences found within the <code>text</code>
     * parameter.
     */
     ...
     * @param search The <code>String</code> values to be searched for in the
     * <code>text</code>
     * @param compare Specifies the string comparison to use.
     * <ul>
     * <li>0 = COMPARE_BINARY - Perform a binary comparison (case
    ...
    /**
     * Removes spaces on both sides of a <code>String</code>. The following
     * example creates the <code>String</code> "Just a Text" from " Just a Text
     * ".
     * <pre>
     * String text = " Just a Text  "
     ...
     * @return without any leading or trailing white spaces or null if the
     * parameter text is null.
     */
    ...
    /**
     * Trims the given <code>text</code> and takes all given <code>trims</code>
     * under account.
     *
    ...
    /**
     * Removes spaces on the left side of a <code>String</code>. The following
     * example creates the <code>String</code> "Just a Text " from " Just a Text
     * ".
     * <pre>
     * String text = " Just a Text  "
     ...
     *
     * @param text The <code>String</code> that should be processed.
     * @return without any leading white spaces or null if the parameter text is
     * null.
     *
     * @see #rtrim(String)
     */
    ...
    /**
     * Removes spaces on the right side of a <code>String</code>. The following
     * example creates the <code>String</code> "Just a Text " from " Just a Text
     * ".
     * <pre>
     * String text = " Just a Text  "
     ...
     *
     * @param text The <code>String</code> that should be processed.
     * @return without any trailing white spaces or null if the parameter text
     * is null.
     *
     * @see #ltrim(String)
     */
    ...
    /**
     * Creates a string that contains a repeating character of a specified
     * length.
     *
     * @param size Number of recurrences.
     * @param repeat The character that should be repeated. The first character
     * of the <code>String</code> will be used.
    ...
    /**
     * Returns the position of the first occurrence of one <code>String</code>
     * within another.
     *
     * @param start Specifies the starting position for each search. Invoke with
     * 1 for start with the first character.
     ...
     * insensitive)</li>
     * </ul>
     * @return The index for the first match. The first character is at position
     * 1. If the match could not be found, 0 will be returned.
     ...
     * @param start Specifies the starting position for each search. Invoke with
     * 1 for start with the first character.
     * @param end Specifies the end position for each search. The first char
     * starts with 1.
     * @param text The <code>String</code> to be searched.
     * @param search The <code>String</code> to search for.
     * @param compare Specifies the string comparison to use.
    ...
    /**
     * Returns the position of the last occurrence of one <code>String</code>
     * within another.
     *
     * @param text The <code>String</code> to be searched.
     * @param search The <code>String</code> to search for.
     * @param start Specifies the starting position for each search. The search
     * begins at the last character if the value -1 is given. The first char
     * starts with 1.
     * @param end Specifies the end position for each search. The first char
     * starts with 1.
     * @param compare Specifies the string comparison to use.
     ...
     * insensitive)</li>
     * </ul>
     * @return The index for the last match. The first character is at position
     * 1. If the match could not be found, 0 will be returned.
     * @throws RuntimeException If the parameter mode is not 0 or 1.
     */
     ...
     * @param search The <code>String</code> to search for.
     * @param start Specifies the starting position for each search. The search
     * begins at the last character if the value -1 is given.
     * @param compare Specifies the string comparison to use.
     * <ul>
     * <li>0 = COMPARE_BINARY - Perform a binary comparison (case
     * sensitive)</li>
    ...
    /**
     * Replaces a specified part of a <code>String</code> with another
     * <code>String</code> a specified number of times.
     *
     * @param text The <code>String</code> to be searched.
     * @param search The part of the <code>String</code> that will be replaced.
     * @param replacement The replacement <code>String</code>.
     * @param start Specifies the start position. Use 1 for starting with the
     * first character.
     * @param count Specifies the number of substitutions to perform. Use -1 for
     * making all possible substitutions.
     * @param compare Specifies the string comparison to use.
     * <ul>
     * <li>0 = VBConstants.COMPARE_BINARY - Perform a binary comparison (case
     * sensitive)</li>
     * <li>1 = VBConstants.COMPARE_TEXT - Perform a textual comparison (case
     * insensitive)</li>
     * </ul>
    ...
    /**
     * This is just a convenience method and does the same as the
     * <code>replace(String, String, String, int, int, int)</code> method. The
     * replacement starts at the position 0 and performs all possible
     * substitutions. The comperatrion method is VBConstants.COMPARE_BINARY.
     *
     * @param text The <code>String</code> to be searched.
     * @param search The part of the <code>String</code> that will be replaced.
     * @param replacement The replacement <code>String</code>.
    ...
    /**
     * This is just a convenience method and does the same as the
     * <code>replace(String, String, String, int, int, int)</code> method to all
     * entries in search. The replacement starts at the position 0 and performs
    ...
    /**
     * convenience method and does the same as the
     * <code>replace(String, String, String[], int)</code> but with
     * UtilConstants.COMPARE_BINARY as compare parameter.
     *
    ...
    /**
     * Replaces a specified part of a <code>String</code> with another
     * <code>String</code> a specified number of times. No replacements will be
     * performed between The open and close definition characters defined with
     * the parameters exclusionBegin and exclusionEnd.
     *
     * @param text The <code>String</code> to be searched.
     * @param search The part of the <code>String</code> that will be replaced.
     * @param replacement The replacement <code>String</code>
    ...
    /**
     * Compares two <code>String</code> and returns a value that represents the
    ...
    /**
     * Removes or Preserves all characters specified with the parameter text2 in
     * the text given with parameter text1.
     *
     * @param text1 <code>String</code> which should be striped.
     * @param text2 <code>String</code> containing all characters to be removed
     * or obtained from the String specified with the parameter text1
     *
     * @param preserve Specifies if the characters in text2 should be removed or
     * preserved in text1. <code>false</code> will preserve the characters
     * specified in text2 and strips all other characters. <code>true</code>
     * removes all characters specified in text2 from text1.
     * @param compare Specifies the string comparison to use.
     * <ul>
     * <li>0 = COMPARE_BINARY - Perform a binary comparison (case
     * sensitive)</li>
     ...
     * insensitive)</li>
     * </ul>
     * @return The striped <code>String</code> or null if one of the parameters
     * is <code>null</code>.
     */
    ...
    /**
     * Creates a <code>String</code> with space (" ") characters appended at the
     * beginning of the string to give the <code>String</code> a length equal to
     * the <code>length</code> parameter. If the length of <code>text</code> is
     * greater than <code>length</code>, than the <code>text</code> will be cut
     * to the <code>length</code>.
     *
    ...
    /**
     * Creates a <code>String</code> with <code>fillChar</code> characters
     * appended at the beginning of the string to give the <code>String</code> a
     * length equal to the <code>length</code> parameter. If the length of
     * <code>text</code> is greater than <code>length</code>, than the
     * <code>text</code> will be cut to the <code>length</code>.
     * <BR><BR>
     * Does the same as <code>{@link #padLeft(String, int)}</code> but allows to
     * specify the character to be used for filling up the String.
     *
     * @param text a string to operate on
    ...
    /**
     * Creates a <code>String</code> with space (" ") characters appended at the
     * end of the string to give the <code>String</code> a length equal to the
     * <code>length</code> parameter. If the length of <code>text</code> is
     * greater than <code>length</code>, than the <code>text</code> will be cut
     * to the <code>length</code>.
     *
     * @param text a string to operate on
    ...
    /**
     * Creates a <code>String</code> with <code>fillChar</code> characters
     * appended at the end of the string to give the <code>String</code> a
     * length equal to the <code>length</code> parameter. If the length of
     * <code>text</code> is greater than <code>length</code>, than the
     * <code>text</code> will be cut to the <code>length</code>.
     * <BR><BR>
     * Does the same as <code>{@link #padRight(String, int)}</code> but allows
     * to specify the character to be used for filling up the String.
     *
     * @param text a string to operate on
    ...
    /**
     * Ensure that the first character of the provided string is upper case. If
     * the first character is an ß it won't capitalized.
     *
    ...
    /**
     * Ensure that the first character of the provided string is lower case. If
     * the first character is an ß it won't uncapitalized.
     *
     * @param text The <code>String</code> to be capitalized.
     * @return The capitalized <code>String</code>.
     */
    ...
    /**
     * The <code>{@link #normalize(String, char[], boolean)}<7CODE> method is
     * designed for removing unwanted characters within a
     * <code>{@link String}</code>. The characters to be removed or to be kept
     * can be specified with the <code>chars</code> parameter. These characters
     * are kept or removed depending on the <code>allow</code> parameter. the
     * result is a String which no longer contains any unwanted character.
     *
     * @param text The text to be normalized. If this parameter is
     * <code>null</code>, the result is also <code>null</code>.
     * @param chars The characters to be kept or removed. If the given array is
     * <code>null</code>, it will be handled like an empty array. You can also
     * use the predefined character sets <code>{@link #CHARSET_ASCII7}</code> or
     * <code>{@link #CHARSET_BASE_64}</code>
     * @param allow The allow flag toggles the keep or remove option. Is this
     * property set to <code>true</code>, all characters within the
     * <code>chars</code> array will be removed from the String. On
     * <code>false</code> the characters specified with the <code>chars</code>
     * array are these ones which will be kept back. That means that all the
     * other characters will be removed for the result.
     *
    ...
    /**
     * Creates the substring of the parameter <code>text1</code> that follows
     * the first occurrence of the parameter <code>text2</code> in the
     * <code>text1</code> parameter string, or the empty string if the
     * <code>text1</code> parameter string does not contain the
     * <code>text2</code> parameter string. If the <code>text1</code> parameter
     * is <code>null</code>, <code>null</code> will be returned. Should never
     * throws any kind of <code>{@link Exception}</code>.
     * <BR><BR>
     *
     ...
     * </code></pre>
     *
     * @param text1 The string to be searched for a match specified with the
     * <code>text2</code> parameter.
     * @param search The string to be searched within the <code>text1</code>
     * parameter string.
     * @param forward <code>true</code> if the <code>text2</code> should be
     * searched forward in <code>text1</code> or <code>false</code> for backward
     * searching. backward searching will find the last occurrence of
     * <code>text2</code> in <code>text1</code>.
     * @param returnAllForNotFound if <code>true</code>, the result for
     * <code>substringAfter("1999/05/01","2")</code> is not an empty string but
     * the full string given with <code>text1</code>
     * @param compare Specifies the string comparison to use.
     * <ul>
     * <li>0 = COMPARE_BINARY - Perform a binary comparison (case
     * sensitive)</li>
     ...
     *
     * @param value The value where the string representation should be fetched
     * for.
     ...
     * @return The cleaned text or <code>null</code> if the given text is
     * <code>null</code>.
     */
    ...
    /**
     * Tests a string if the first two arguments cross match to the second both
     * arguments. For example "create" and "creation" should be compared as a
     * true value, both can be given as the second argments to return true. If
     * any of the first both string did not match to the second ones,
     ...
     * @return <code>true</code> if the string is empty or <code>false</code>
     * otherwise.
     */
    ...
    /**
     * Tests if the given string is not empty. That means it's <code>null</code>
     * or have a trimmed length of null.
     *
     * @param text The text to be tested.
     * @return <code>true</code> if the string is not empty or
     ...
     * relate similar names, but can also be used as a general purpose scheme to
     * find word with similar phonemes.
     *
     * @param stringToEncode The <code>String</code> to be encoded using the
     * soundex algorithm.
        ...
        for (int i = 0; i < charArrayToEncode.length; i++) {
            ...
            if (charArrayToEncode[i] >= 'A' && charArrayToEncode[i] <= 'Z') {
                switch (charArrayToEncode[i]) {
                    ...
                    case 'X':
                    case 'Z': {
                        charArrayToEncode[i] = '2';
                        break;
                    }

                    case 'D':
                    case 'T': {
                        charArrayToEncode[i] = '3';
                        break;
                    }

                    case 'L': {
                        charArrayToEncode[i] = '4';
                        break;
                    }

                    case 'M':
                    case 'N': {
                        charArrayToEncode[i] = '5';
                        break;
                    }

                    case 'R': {
                        charArrayToEncode[i] = '6';
                        break;
                    }
    ...
    /**
     * Encodes a <code>String</code> using the trivial "Rot13" substitution
     * cipher. Rot13 works by replacing each upper and lower case letters with
     * the letter 13 positions ahead or behind it in the alphabet. The
     * encryption algorithm is symmetric - applying the same algorithm a second
     * time recovers the original message.
     *
     * @param strinToEncode The <code>String</code> to be encoded with the rot13
     * algorithm.
    ...
    /**
     * Decodes a punycode encoded string. For example "abcdef-qua4k" to
     * "abæcdöef"
     *
...
//        }
    ...
    /**
     * Decodes an URL encoded string. For example something like "abc%20d" to
     * "abc d"
     *
     * @param toDecode The string to be decoded.
     ...
     * String as well as with StringBuilder or any other {@link CharSequence}
     * implementations.
     *
     * @param text The text to be tested if it ends with.
     * @param search The char to be tested if the given text ends with it.
     * @return <code>true</code> if the given text ends with the given char and
     * <code>false</code> otherwise.
     */
     ...
     * @return <code>true</code> if the given text ends with the given search
     * String and <code>false</code> otherwise.
     */
    ...
    /**
     * Searches for the given <code>search</code> string in the given
     * <code>text</code>. This implementation is faster than using
     * {@link #inStr(String, String, int, int)}.
     *
     * @param text The text to be searched.
     * @param search The search string to find.
     * @param start The start location for the find process in the
     * <code>text</code>
     * @param compare Specifies the string comparison to use.
     * <ul>
     * <li>0 = COMPARE_BINARY - Perform a binary comparison (case
     ...
     * @return The quoted text. Returns <code>null</code> if the given text is
     * <code>null</code>.
     */
     ...
     * (%) or underscore (_) for use in LIKE clauses.</p>
     *
    ...
    /**
     * Get the text between the first occurrence of <code>begin</code> and the
     * <code>end</code> part including the begin and the end part.
     *
     ...
     * @return The text part or <code>null</code> if <code>text</code> did not
     * contain any matching part.
     */
