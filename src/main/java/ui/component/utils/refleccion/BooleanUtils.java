...
public class BooleanUtils {
     ...
     * @param defaultValue The value which is returned if the conversion is not
     * possible.
     * @return the boolean instance or the <code>defaultValue</code> if the
     * given parameter could not be converted.
     */
     ...
     *
     * @param object
     * @return the boolean instance or <code>null</code> if the given parameter
